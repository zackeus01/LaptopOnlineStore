            ...
            <div class="container">
                ...
                <div class="cart-view">
                    <table class="cart-view-table">
                        ...
                        %>
                        <tr>
                            <td><input type="checkbox" onchange="handleCheckboxChange(this, '<%= c.getSeri() %>')"></td>
                            <td class="product-image"><img src="<%= c.getImg() %>" alt="Product Image"></td>
                            <td class="product-name"><%= c.getpName() %></td>

                            <td class="quantity">
                                <div class="quantity">
                                    <input id="quantityInput<%= c.getSeri() %>" type="text" value="<%= c.getQuantity() %>">
                            ...
                            %>
                            <td class="total-price" id="total<%= c.getSeri() %>"><fmt:formatNumber type="currency" value="<%= totalPrice %>" currencyCode="VND" maxFractionDigits="0" /></td>
                    ...
                    <div class="cart-view-table">
                        ...
                        <script>
                            ...
                            function handleCheckboxChange(checkbox, seri) {
                                var isChecked = checkbox.checked;

                                if (isChecked) {
                                    selectedSerialNumbers.push(seri);
                                } else {
                                    var index = selectedSerialNumbers.indexOf(seri);
                                    if (index !== -1) {
                                        selectedSerialNumbers.splice(index, 1);
                                    }
                                    // Thực hiện bất kỳ thao tác dọn dẹp hoặc xóa nào khác nếu cần thiết
                                }
                            }

                            function handleCheckout() {

                                var listseriString = selectedSerialNumbers.join(","); // Chuyển danh sách thành chuỗi ngăn cách bằng dấu phẩy
                                window.location.href = "checkout?selectedSerialNumbers=" + listseriString;
                            }
                        </script>
