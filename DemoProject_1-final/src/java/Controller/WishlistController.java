...
public class WishlistController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Cart> wishlists = (List<Cart>) session.getAttribute("WistList");
        ...
        if (session.getAttribute("acc") != null) {
            ...
            if (wishlists == null) {
                ...
                wishlists.add(new Cart(seri, pName, p.getImg(), 1, p.getPrice()));
            } else {
            ...
            session.setAttribute("WistList", wishlists);
        ...
        if (request.getParameter("delwishlish") != null) {
            String seri = request.getParameter("seri");
            ...
            wishlists.removeAll(itemsToRemove);
